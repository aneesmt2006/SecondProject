...
import type { TuserResponseDTO,TregisterRequestDTO, TgoogleAuthResponse, TprofileDTO } from "../../dtos/user.dto.js";
export interface IAuthService {
  register(userData: TregisterRequestDTO):Promise<{message:string,email:string}>;
  lmpUpdate(id:string,userData:TprofileDTO):Promise<{user:TuserResponseDTO,message:string}>;
